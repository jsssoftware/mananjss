  ...
  createPolicy(): any {
    ...
    let model: ICommercialPolicyFormDataModel = {
      ...
      TpPolicy: {
        ...
        LineofBusiness : this.PolicyForm.lineofBusiness,
        Occupancy: this.PolicyForm.occupancy,
        BasementExposure :  this.PolicyForm.basementExposure,
      ...
      Premium: {
        ...
        TerrorimsPremium : Number(this.PremiumForm.terrorimsPremium)
      },
