...
export class IndustryComponent implements OnInit {
  ...
  get(): any {
    ...
    this.masterSerivice.getIndustry(this._branchId).subscribe((response: IDataTableDto<any[]>) => {
  ...
  create(){
    ...
    this.masterSerivice.createIndustry(this.form.getRawValue()).subscribe((response: ICommonDto<any>) => {
