...
export class DesignationComponent implements OnInit {
  ...
  get(): any {
    ...
    this.masterSerivice.getDesignation(this._branchId).subscribe((response: IDataTableDto<any[]>) => {
  ...
  create(){
    ...
    this.masterSerivice.createDesignation(this.form.getRawValue()).subscribe((response: ICommonDto<any>) => {
