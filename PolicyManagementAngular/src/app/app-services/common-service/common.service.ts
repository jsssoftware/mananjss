...
export class CommonService extends ICommonService {
    ...
    getPlan = (productId: number,insuranceCompanyId:number ,verticalId:number): Observable<IDropDownDto<string>> => this.apiManagerService.getRequest<IDropDownDto<string>>(`${Common.Plan}?productId=${productId}&insuranceCompanyId=${insuranceCompanyId}&verticalId=${verticalId}`);
    ...
    getCommisionInland = (): Observable<IDropDownDto<number>[]> => this.apiManagerService.getRequest<IDropDownDto<number>[]>(Common.CoverageInland);
    ...
    getPosTitle = (): Observable<IDropDownDto<number>[]> => this.apiManagerService.getRequest<IDropDownDto<string>>(`${Common.Postitle}`);
    getType = (): Observable<IDropDownDto<number>[]> => this.apiManagerService.getRequest<IDropDownDto<string>>(`${Common.Type}`);
    getCategory = (): Observable<IDropDownDto<number>[]> => this.apiManagerService.getRequest<IDropDownDto<string>>(`${Common.Category}`);
    getTerritory = (): Observable<IDropDownDto<number>[]> => this.apiManagerService.getRequest<IDropDownDto<string>>(`${Common.Territory}`);
    getVehicleClassType = (): Observable<IDropDownDto<number>[]> => this.apiManagerService.getRequest<IDropDownDto<string>>(`${Common.VehicleClassType}`);
    getVehicleSegment = (): Observable<IDropDownDto<number>[]> => this.apiManagerService.getRequest<IDropDownDto<string>>(`${Common.VehicleClassSegment}`);
    getFuelType = (): Observable<IDropDownDto<number>[]> => this.apiManagerService.getRequest<IDropDownDto<string>>(`${Common.FuelType}`);
    ...
    getAllPlans = (productId: number,insuranceCompanyId:number): Observable<any[]> => this.apiManagerService.getRequest<IDropDownDto<string>>(`${Common.AllPlans}?productId=${productId}&insuranceCompanyId=${insuranceCompanyId}`);
    getAllPosManagedBy = (branchId: number): Observable<IDropDownDto<number>[]> => this.apiManagerService.getRequest<IDropDownDto<string>>(`${Common.AllPosMaanagedBy}/${branchId}`);
    getAllEndrosementReason = (verticalId: number,endrosementType : number): Observable<IDropDownDto<number>[]> => this.apiManagerService.getRequest<IDropDownDto<string>>(`${Common.AllEndrosementReason}/${verticalId}/${endrosementType}`);
    getBounceReason = (): Observable<IDropDownDto<number>[]> => this.apiManagerService.getRequest<IDropDownDto<string>>(`${Common.AllBounceReason}`);
